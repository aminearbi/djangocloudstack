...
while 1:
    ...
    print "################################################"
    print "              WELCOME TO CLOUDSTACK             "
    print "################################################"

    print "please select what de you want to do"
    print " 1-Create a Virual Machine \n 2-Start an Existing Virtual Machine\n 3-Stop an Existing Virtual Machine"
    print " 4-Destroy an Existing Virtual Machine \n 5-Create a Virtual Machine With embadded portforwarding \n 6-Create a PortForwarding Rule"
    ...
    if (input=='1'):
        ...
        CreateVMwithPortForwarding()
    elif (input=='6'):
        Portforwarding()
    elif (input=='7'):
        TemplateCreation()
    elif (input=='8'):
        for vl in cloudclient.listOsTypes({'keyword':'cent'}):
           print vl['description']
    elif (input=='9'):
        exit()
    else:
        pass
